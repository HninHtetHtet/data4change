...
var label1=[];
      ...
      label1.push(0);	   
		var ctx = document.getElementById('c37').getContext('2d');
...
var label2=[];
      ...
      label2.push(0);	   
		var ctx = document.getElementById('c38').getContext('2d');
...
var label3=[];
      ...
      label3.push(0);	   
		var ctx = document.getElementById('c39').getContext('2d');
...
var label4=[];
     ...
     for(var i=18;i<25;i++){
      ...
      label4.push(0);	   
		var ctx = document.getElementById('c40').getContext('2d');
