...
var label1=[];
      ...
      label1.push(0);	   
		var ctx = document.getElementById('c49').getContext('2d');
...
var label2=[];
     ...
     for(var i=32;i<41;i++){
      ...
      label2.push(0);	   
		var ctx = document.getElementById('c50').getContext('2d');
...
var label3=[];
      ...
      label3.push(0);	   
		var ctx = document.getElementById('c51').getContext('2d');
...
var label4=[];
     ...
     for(var i=32;i<41;i++){
      ...
      label4.push(0);	   
		var ctx = document.getElementById('c52').getContext('2d');
