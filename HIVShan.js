...
var label1=[];
      ...
      label1.push(0);	   
		var ctx = document.getElementById('c45').getContext('2d');
...
var label2=[];
     ...
     for(var i=241;i<296;i++){
      ...
      label2.push(0);	   
		var ctx = document.getElementById('c46').getContext('2d');
...
var label3=[];
   ...
   for(var i=241;i<296;i++){
      ...
      label3.push(0);	   
		var ctx = document.getElementById('c47').getContext('2d');
...
var label4=[];
  ...
  for(var i=241;i<296;i++){
      ...
      label4.push(0);	   
		var ctx = document.getElementById('c48').getContext('2d');
