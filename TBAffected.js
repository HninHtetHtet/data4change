...
for(var i=78;i<88;i++){
      	...
      	label6.push(da[i].DISAF03);
      }	
      label6.push(0);	   
		var ctx = document.getElementById('t6').getContext('2d');
...
for(var i=88;i<116;i++){
      	...
      	label7.push(da[i].DISAF03);
      }	
      label7.push(0);	   
		var ctx = document.getElementById('t7').getContext('2d');
...
for(var i=116;i<141;i++){
      	...
      	label8.push(da[i].DISAF03);
      }	
      label8.push(0);	   
		var ctx = document.getElementById('t8').getContext('2d');
...
for(var i=141;i<169;i++){
      	...
      	label9.push(da[i].DISAF03);
      }	
      label9.push(0);	   
		var ctx = document.getElementById('t9').getContext('2d');
...
for(var i=169;i<179;i++){
      	...
      	label10.push(da[i].DISAF03);
      }	
      label10.push(0);	   
		var ctx = document.getElementById('t10').getContext('2d');
...
for(var i=179;i<196;i++){
      	...
      	label11.push(da[i].DISAF03);
      }	
      label11.push(0);	   
		var ctx = document.getElementById('t11').getContext('2d');
...
for(var i=196;i<241;i++){
      	...
      	label12.push(da[i].DISAF03);
      }	
      label12.push(0);	   
		var ctx = document.getElementById('t12').getContext('2d');
...
for(var i=241;i<296;i++){
      	...
      	label13.push(da[i].DISAF03);
      }	
      label13.push(0);	   
		var ctx = document.getElementById('t13').getContext('2d');
...
for(var i=296;i<322;i++){
      	...
      	label14.push(da[i].DISAF03);
      }	
      label14.push(0);	   
		var ctx = document.getElementById('t14').getContext('2d');
...
for(var i=322;i<330;i++){
      	...
      	label15.push(da[i].DISAF03);
      }	
      label15.push(0);	   
		var ctx = document.getElementById('t15').getContext('2d');
