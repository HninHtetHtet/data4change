...
var label1=[];
      ...
      label1.push(0);	   
		var ctx = document.getElementById('c53').getContext('2d');
...
var label2=[];
     ...
     for(var i=78;i<88;i++){
      ...
      label2.push(0);	   
		var ctx = document.getElementById('c54').getContext('2d');
...
var label3=[];
      ...
      label3.push(0);	   
		var ctx = document.getElementById('c55').getContext('2d');
...
var label4=[];
    ...
    for(var i=78;i<88;i++){
      ...
      label4.push(0);	   
		var ctx = document.getElementById('c56').getContext('2d');
