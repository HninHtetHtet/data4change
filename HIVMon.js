...
var label1=[];
      ...
      label1.push(0);	   
		var ctx = document.getElementById('c29').getContext('2d');
...
var label2=[];
     ...
     for(var i=169;i<179;i++){
      ...
      label2.push(0);	   
		var ctx = document.getElementById('c30').getContext('2d');
...
var label3=[];
     ...
     for(var i=169;i<179;i++){
      ...
      label3.push(0);	   
		var ctx = document.getElementById('c31').getContext('2d');
...
var label4=[];
   ...
   for(var i=169;i<179;i++){
      ...
      label4.push(0);	   
		var ctx = document.getElementById('c32').getContext('2d');
