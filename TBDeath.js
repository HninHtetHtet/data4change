...
for(var i=78;i<88;i++){
      	...
      	label6.push(da[i].DISDD03);
      }	
      label6.push(0);	   
		var ctx = document.getElementById('td6').getContext('2d');
...
for(var i=88;i<116;i++){
      	...
      	label7.push(da[i].DISDD03);
      }	
      label7.push(0);	   
		var ctx = document.getElementById('td7').getContext('2d');
...
for(var i=116;i<141;i++){
      	...
      	label8.push(da[i].DISDD03);
      }	
      label8.push(0);	   
		var ctx = document.getElementById('td8').getContext('2d');
...
for(var i=141;i<169;i++){
      	...
      	label9.push(da[i].DISDD03);
      }	
      label9.push(0);	   
		var ctx = document.getElementById('td9').getContext('2d');
...
for(var i=169;i<179;i++){
      	...
      	label10.push(da[i].DISDD03);
      }	
      label10.push(0);	   
		var ctx = document.getElementById('td10').getContext('2d');
...
for(var i=179;i<196;i++){
      	...
      	label11.push(da[i].DISDD03);
      }	
      label11.push(0);	   
		var ctx = document.getElementById('td11').getContext('2d');
...
for(var i=196;i<241;i++){
      	...
      	label12.push(da[i].DISDD03);
      }	
      label12.push(0);	   
		var ctx = document.getElementById('td12').getContext('2d');
...
for(var i=241;i<296;i++){
      	...
      	label13.push(da[i].DISDD03);
      }	
      label13.push(0);	   
		var ctx = document.getElementById('td13').getContext('2d');
...
for(var i=296;i<322;i++){
      	...
      	label14.push(da[i].DISDD03);
      }	
      label14.push(0);	   
		var ctx = document.getElementById('td14').getContext('2d');
...
for(var i=322;i<330;i++){
      	...
      	label15.push(da[i].DISDD03);
      }	
      label15.push(0);	   
		var ctx = document.getElementById('td15').getContext('2d');
